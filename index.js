...
render(<Media type="video" title="¿Qué es Responsive Design?" author="JesusKata" image="./images/covers/responsive.jpg" />, app); // < > se usa para que ReactDOM reconozca nuestro componente
